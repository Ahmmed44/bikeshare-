# -*- coding: utf-8 -*-
"""
Created on Fri Aug 13 18:07:28 2021
@author: Win10
"""
import time
import pandas as pd
...
while True:    
        month = input("Do you want to know specific to a particular month? If yes, type month name from within the first six months else type all")
        month = month.lower()
 ...
 while True:
        days = input("Do you want details specific to a particular day? If yes, type day name else type 'all'")
        days = days.lower()
        if days  in['Saturdat','Sunday','Monday','Tuesday','Wendesday','Thursdy','Friday','All'] : 
            break
        else:
            print("invalid input.")
